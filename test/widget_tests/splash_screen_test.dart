  ...
  group('SplashScreen Widget Tests', () {
    testWidgets('должен отображать все основные элементы заставки', 
      ...
      await tester.pumpWidget(
        createMaterialTestWidget(SplashScreen()),
      );
    ...
    testWidgets('должен быть доступным для людей с ограниченными возможностями', 
        (WidgetTester tester) async {
      await tester.pumpWidget(
        createMaterialTestWidget(SplashScreen()),
      );
    ...
    testWidgets('должен сохранять позиционирование при разных размерах экрана', 
        (WidgetTester tester) async {
